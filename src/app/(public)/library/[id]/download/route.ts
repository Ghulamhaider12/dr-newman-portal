...
export async function GET(_req: Request, { params }: { params: { id: string } }) {
  ...
  // Signed Spaces URLs are absolute; local-fallback URLs are relative. Never
  // absolutize against the request — behind a proxy that host is the internal
  // localhost:3000. A relative Location resolves against the browser's origin.
